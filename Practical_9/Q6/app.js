...
document.addEventListener("DOMContentLoaded", () => {
    ...
    btnMath.addEventListener("click", () => {
        const output = document.getElementById("output-math");
    ...
    btnSalary.addEventListener("click", () => {
        ...
        const baseInput = document.getElementById("base-salary").value;
        const output = document.getElementById("output-salary");
    ...
    btnBook.addEventListener("click", () => {
        const output = document.getElementById("output-book");
