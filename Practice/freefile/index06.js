...
{/* <tr class="myrow" id = "row1" style="red for nc and green for c">
                <td>1</td>
                <td>Assignment</td>
                <td>false</td>
...
function createTableRow(taskObj){
    ...
    tr.setAttribute("id","myid");
    // tr.setAttribute("id",`row ${taskObj.id});
    ...
    if (taskObj.completed == true) {
        td3.innerText = "Completed";
    } else {
        td3.innerText = "Not Completed";
    }

    let td4 = document.createElement("td");
    let delbtn = document.createElement("button");
    delbtn.innerText = `Delete Task ${(taskObj.id)} `;
