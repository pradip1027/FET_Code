...
function createTableRow(taskObj) {
  let tr = document.createElement("tr");

  let td1 = document.createElement("td");
  td1.innerHTML = taskObj.id;

  let td2 = document.createElement("td");
  td2.innerHTML = taskObj.firstName;

  let td3 = document.createElement("td");
  td3.innerHTML = taskObj.lastName;

  let td4 = document.createElement("td");
  td4.innerHTML = taskObj.maidenName;

  let td5 = document.createElement("td");
  td5.innerHTML = taskObj.age;

  let td6 = document.createElement("td");
  td6.innerHTML = taskObj.gender;

  let td7 = document.createElement("td");
  td7.innerHTML = taskObj.email;

  let td8 = document.createElement("td");
  td8.innerHTML = taskObj.phone;

  let td9 = document.createElement("td");
  td9.innerHTML = taskObj.username;

  let td10 = document.createElement("td");
  td10.innerHTML = taskObj.password;

  let td11 = document.createElement("td");
  td11.innerHTML = taskObj.birthDate;
  ...
  td13.innerHTML = taskObj.bloodGroup;

  let td14 = document.createElement("td");
  td14.innerHTML = taskObj.height;

  let td15 = document.createElement("td");
  td15.innerHTML = taskObj.weight;

  let td16 = document.createElement("td");
  td16.innerHTML = taskObj.eyeColor;

  let td17 = document.createElement("td");
  td17.innerHTML = taskObj.hair.color;

  let td18 = document.createElement("td");
  td18.innerHTML = taskObj.hair.type;

  let td19 = document.createElement("td");
  td19.innerHTML = taskObj.ip;

  let td20 = document.createElement("td");
  td20.innerHTML = taskObj.address.address;

  let td21 = document.createElement("td");
  td21.innerHTML = taskObj.address.city;

  let td22 = document.createElement("td");
  td22.innerHTML = taskObj.address.state;

  let td23 = document.createElement("td");
  td23.innerHTML = taskObj.address.stateCode;

  let td24 = document.createElement("td");
  td24.innerHTML = taskObj.address.postalCode;

  let td25 = document.createElement("td");
  td25.innerHTML = taskObj.address.coordinates.lat;

  let td26 = document.createElement("td");
  td26.innerHTML = taskObj.address.coordinates.lng;

  let td27 = document.createElement("td");
  td27.innerHTML = taskObj.address.country;

  let td28 = document.createElement("td");
  td28.innerHTML = taskObj.macAddress;

  let td29 = document.createElement("td");
  td29.innerHTML = taskObj.university;

  let td30 = document.createElement("td");
  td30.innerHTML = taskObj.bank.cardExpire;

  let td31 = document.createElement("td");
  td31.innerHTML = taskObj.bank.cardNumber;

  let td32 = document.createElement("td");
  td32.innerHTML = taskObj.bank.cardType;

  let td33 = document.createElement("td");
  td33.innerHTML = taskObj.bank.currency;

  let td34 = document.createElement("td");
  td34.innerHTML = taskObj.bank.iban;

  let td35 = document.createElement("td");
  td35.innerHTML = taskObj.company.department;

  let td36 = document.createElement("td");
  td36.innerHTML = taskObj.company.name;

  let td37 = document.createElement("td");
  td37.innerHTML = taskObj.company.title;

  let td38 = document.createElement("td");
  td38.innerHTML = taskObj.company.address.address;

  let td39 = document.createElement("td");
  td39.innerHTML = taskObj.company.address.city;

  let td40 = document.createElement("td");
  td40.innerHTML = taskObj.company.address.state;

  let td41 = document.createElement("td");
  td41.innerHTML = taskObj.company.address.stateCode;

  let td42 = document.createElement("td");
  td42.innerHTML = taskObj.company.address.postalCode;

  let td43 = document.createElement("td");
  td43.innerHTML = taskObj.company.address.coordinates.lat;

  let td44 = document.createElement("td");
  td44.innerHTML = taskObj.company.address.coordinates.lng;

  let td45 = document.createElement("td");
  td45.innerHTML = taskObj.company.address.country;

  let td46 = document.createElement("td");
  td46.innerHTML = taskObj.ein;

  let td47 = document.createElement("td");
  td47.innerHTML = taskObj.ssn;

  let td48 = document.createElement("td");
  td48.innerHTML = taskObj.userAgent;

  let td49 = document.createElement("td");
  td49.innerHTML = taskObj.crypto.coin;

  let td50 = document.createElement("td");
  td50.innerHTML = taskObj.crypto.wallet;

  let td51 = document.createElement("td");
  td51.innerHTML = taskObj.crypto.network;

  let td52 = document.createElement("td");
  td52.innerHTML = taskObj.role;
...
function createTableRows(taskarray) {
  for (let i = 0; i < taskarray.length; i++) {
    createTableRow(taskarray[i]);
  }
}
